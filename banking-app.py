...
# def view_transactions(transactions_window):
#     try:
...
#     Button(transactions_window, text="Download Transaction History", font=('Calibri', 12), command=lambda: download_transactions(transactions)).grid(row=7, columnspan=2, pady=10)
...
#                 # Create a Text widget for displaying transactions
#                 global text
#                 text = Text(transaction_screen, wrap=WORD, font=('Calibri', 12))
#                 text.grid(row=6, columnspan=2, pady=10)

#                 # Button to view transactions
#                 Button(transaction_screen, text="View Transactions", font=('Calibri', 12), command=lambda: view_transactions(transaction_screen)).grid(row=5, pady=10)
